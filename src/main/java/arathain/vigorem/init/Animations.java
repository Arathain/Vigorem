...
public class Animations {
	...
	public static void init() {
		...
		cache.add(new Keyframe(Easing.SINE_OUT, Vec3f.ZERO, new Vec3f(-1.402f, 0.09f, 0.5236f), Vec3f.ZERO,  Vec3f.ZERO, 15));
		cache.add(new Keyframe(Easing.LINEAR, Vec3f.ZERO, new Vec3f(-1.6345f, -0.06f, 0.4849f), Vec3f.ZERO,  Vec3f.ZERO, 20));
		cache.add(new Keyframe(Easing.QUAD_IN_OUT, Vec3f.ZERO, new Vec3f(-1.6345f, -0.06f, 0.4849f), Vec3f.ZERO, Vec3f.ZERO, 25));
		cache.add(new Keyframe(Easing.QUAD_IN_OUT, Vec3f.ZERO, Vec3f.ZERO, Vec3f.ZERO, Vec3f.ZERO, 33));
