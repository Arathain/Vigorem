...
public class Animations {
	...
	public static void init() {
		...
		cache.add(new Keyframe(Easing.SINE_OUT, Vec3f.ZERO, new Vec3f(0, 0.5f, 0), Vec3f.ZERO,  Vec3f.ZERO, 15));
		cache.add(new Keyframe(Easing.LINEAR, Vec3f.ZERO, new Vec3f(0, 0.5f, 0), Vec3f.ZERO,  Vec3f.ZERO, 20));
		cache.add(new Keyframe(Easing.QUAD_IN_OUT, Vec3f.ZERO, new Vec3f(0, 0.5f, 0), Vec3f.ZERO, Vec3f.ZERO, 25));
		cache.add(new Keyframe(Easing.QUAD_IN_OUT, Vec3f.ZERO, Vec3f.ZERO, Vec3f.ZERO, Vec3f.ZERO, 33));
