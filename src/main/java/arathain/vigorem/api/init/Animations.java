...
public class Animations {
	...
	public static void init() {
		...
		cache.add(new Keyframe(Easing.SINE_OUT, new Vec3f(0, 0, -10), new Vec3f(0, 0, 0), Vec3f.ZERO,  Vec3f.ZERO, 15));
		cache.add(new Keyframe(Easing.LINEAR, new Vec3f(0, 0, -10), new Vec3f(0, 0, 0), Vec3f.ZERO,  Vec3f.ZERO, 20));
		cache.add(new Keyframe(Easing.QUAD_IN_OUT, new Vec3f(0, 0, -10), new Vec3f(0, 0, 0), Vec3f.ZERO, Vec3f.ZERO, 25));
		cache.add(new Keyframe(Easing.QUAD_IN_OUT, Vec3f.ZERO, Vec3f.ZERO, Vec3f.ZERO, Vec3f.ZERO, 33));
