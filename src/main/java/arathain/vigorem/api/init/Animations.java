...
//		TPOSE_END.put("global", new ArrayList<>(cache));
		...
		cache.add(new Keyframe(Easing.QUAD_IN, new Vec3f(0f, -3f, 0f), deg(0f, 0f, 0f), new Vec3f(1.02f, 1.02f, 1.02f), Vec3f.ZERO, 0.0f, false));
		cache.add(new Keyframe(Easing.LINEAR, new Vec3f(0f, -3f, 0f), deg(0f, 0f, 0f), new Vec3f(1.02f, 1.02f, 1.02f), Vec3f.ZERO, 20, false));
		SNEAK.put("head", new ArrayList<>(cache));
		cache.clear();
		cache.add(new Keyframe(Easing.QUAD_IN, new Vec3f(0f, -2f, 4f), deg(40f, 0f, 0f), Vec3f.ZERO, new Vec3f(0, -12, 0), 0.0f));
		cache.add(new Keyframe(Easing.QUAD_OUT, new Vec3f(0f, -1.5f, 4f), deg(39f, 0f, 0f), Vec3f.ZERO, new Vec3f(0, -12, 0), 5.0f));
		cache.add(new Keyframe(Easing.QUAD_IN, new Vec3f(0f, -2f, 4f), deg(40f, 0f, 0f), Vec3f.ZERO, new Vec3f(0, -12, 0), 10.0f));
		cache.add(new Keyframe(Easing.QUAD_OUT, new Vec3f(0f, -1.5f, 4f), deg(39f, 0f, 0f), Vec3f.ZERO, new Vec3f(0, -12, 0), 15.0f));
		cache.add(new Keyframe(Easing.LINEAR, new Vec3f(0f, -2f, 4f), deg(40f, 0f, 0f), Vec3f.ZERO, new Vec3f(0, -12, 0), 20));
		SNEAK.put("body", new ArrayList<>(cache));
		cache.clear();
		cache.add(new Keyframe(Easing.SINE_IN, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 0.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 8f), Vec3f.ZERO, Vec3f.ZERO, 2.5f, false));
		cache.add(new Keyframe(Easing.SINE_IN, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 5.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 12f), Vec3f.ZERO, Vec3f.ZERO, 7.5f, false));
		cache.add(new Keyframe(Easing.SINE_IN, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 10.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 8f), Vec3f.ZERO, Vec3f.ZERO, 12.5f, false));
		cache.add(new Keyframe(Easing.SINE_IN, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 15.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 12f), Vec3f.ZERO, Vec3f.ZERO, 17.5f, false));
		cache.add(new Keyframe(Easing.LINEAR, new Vec3f(0f, -3f, 0f), deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 20, false));
		...
		cache.add(new Keyframe(Easing.CUBIC_OUT, new Vec3f(0f, -2f, 0.5f), deg(15f, 0f, -2f), Vec3f.ZERO, Vec3f.ZERO, 5.0f));
		...
		cache.add(new Keyframe(Easing.CUBIC_OUT, new Vec3f(0f, -2f, 0.5f), deg(15f, 0f, 2f), Vec3f.ZERO, Vec3f.ZERO, 15.0f));
