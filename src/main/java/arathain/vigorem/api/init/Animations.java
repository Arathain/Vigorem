...
//		TPOSE_END.put("global", new ArrayList<>(cache));
		...
		cache.clear();
		cache.add(new Keyframe(Easing.SINE_IN, Vec3f.ZERO, deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 0.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, Vec3f.ZERO, deg(-20f, 0f, 8f), Vec3f.ZERO, Vec3f.ZERO, 2.5f, false));
		cache.add(new Keyframe(Easing.SINE_IN, Vec3f.ZERO, deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 5.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, Vec3f.ZERO, deg(-20f, 0f, 12f), Vec3f.ZERO, Vec3f.ZERO, 7.5f, false));
		cache.add(new Keyframe(Easing.SINE_IN, Vec3f.ZERO, deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 10.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, Vec3f.ZERO, deg(-20f, 0f, 8f), Vec3f.ZERO, Vec3f.ZERO, 12.5f, false));
		cache.add(new Keyframe(Easing.SINE_IN, Vec3f.ZERO, deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 15.0f, false));
		cache.add(new Keyframe(Easing.SINE_OUT, Vec3f.ZERO, deg(-20f, 0f, 12f), Vec3f.ZERO, Vec3f.ZERO, 17.5f, false));
		cache.add(new Keyframe(Easing.LINEAR, Vec3f.ZERO, deg(-20f, 0f, 10f), Vec3f.ZERO, Vec3f.ZERO, 20, false));
